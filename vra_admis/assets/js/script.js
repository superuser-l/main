...
async function marqueeTitle() {
    const atSymbol = "@";
    let title = atSymbol + "VRA || ADMIS"; // Initial title with space to create the effect
...
function typerStartTyping(typer) {
  ...
  let text = [
    "for nature we are artist", 
"for environment we are artful",
"for poor we are affordable ",
"for rich we are acclaimable" , 
"for friends we are active ",
"for enemies we are attackers",
"join us because we are amazing" ,
"at the end we are anonymous"
